...
-- The faucet pool is finite — when it hits zero, distribution stops.
...
-- Faucet pool view — how many tokens remain for distribution
-- Only counts faucet-purpose funding vs faucet-reason distributions.
-- Endowments do NOT draw from the pool.
